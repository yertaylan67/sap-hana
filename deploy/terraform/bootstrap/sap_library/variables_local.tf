...
locals {
  ...
  deployer_environment    = local.deployer.environment
  ...
  deployer_rg_name = try(local.deployer.resource_group_name, format("%s-INFRASTRUCTURE",module.sap_namegenerator.naming.prefix.DEPLOYER))
